...
<body>
    ...
    <div id="content">
        ...
        <div id="right">
            <div id="welcome" style="height: 350px;width:735px;overflow-y:scroll;">
            
                <table style="width:715px;"><thead><tr><th COLSPAN="4"><h3 style="text-align:left;">Resultado do relatório</h3></th>
