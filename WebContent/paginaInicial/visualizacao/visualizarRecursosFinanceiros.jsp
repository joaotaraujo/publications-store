    ...
    <div id="content">
        ...
        <div id="right">
            <div id="welcome" style="overflow-y:scroll;">
                <button onclick="window.location.href='/TP01_publicacoesUFSJ/paginaInicial/cadastros/cadastrarRecursoFinanceiro.jsp'">Cadastrar Recurso Financeiro</button>
                <br><br>
                <table style="width:715px;"><thead><tr><th COLSPAN="4"><h3 style="text-align:left;">Recursos Financeiros</h3></th>
                         </tr></thead><tbody></tbody></thead>
                </table>

                ${recursosFinanceirosTabela}  
