        ...
        <div id="right">
            <div id="welcome" style="overflow-y:scroll;height:350px;">
            		<table border="1" width="30%" cellpadding="2">
                            <thead>
                                <tr>
                                    <th colspan="2"><h3>Relatórios</h3></th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
                    ...
                    <%if (session.getAttribute("tipoUsuario").equals("Administrador") || session.getAttribute("tipoUsuario").equals("Pro-reitor de pesquisa")) {%>
				    <h1>Produções</h1>
				    	<li class="link"><a href="/TP01_publicacoesUFSJ/ServletCarregaRelatorio?tipoRelatorio=numProducoesPorDepartamento">Número de produções por departamento</a></li>
       					<li class="link"><a href="/TP01_publicacoesUFSJ/ServletCarregaRelatorio?tipoRelatorio=numProducoesPorUsuario">Número de produções por usuário</a></li>
       					<li class="link"><a href="/TP01_publicacoesUFSJ/ServletCarregaRelatorio?tipoRelatorio=numProducoesPorGrandeArea">Número de produções por grande área</a></li>
       				<h1>Recursos Financeiros</h1>
       					<li class="link"><a href="/TP01_publicacoesUFSJ/ServletCarregaRelatorio?tipoRelatorio=numRecursosPorGrandeArea">Número de recursos por grande área</a></li>
       					<li class="link"><a href="/TP01_publicacoesUFSJ/ServletCarregaRelatorio?tipoRelatorio=numRecursosPorPrograma">Número de recursos por programa</a></li>
       					<li class="link"><a href="/TP01_publicacoesUFSJ/ServletCarregaRelatorio?tipoRelatorio=numRecursosPorProducao">Número de recursos por produção</a></li>
       				<%}else{%>
