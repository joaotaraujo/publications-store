    ...
    <div id="content">
        ...
        <div id="right">
            ...
            <%if (session.getAttribute("tipoUsuario").equals("Administrador")) {%>
                <button onclick="window.location.href='/TP01_publicacoesUFSJ/paginaInicial/cadastros/cadastrarUsuario.jsp'">Cadastrar usuário</button>
               <%}%>
                <br><br>
                <table style="width:715px;"><thead><tr><th COLSPAN="4"><h3 style="text-align:left;">Usuários</h3></th>
