    ...
    <div id="content">
        ...
        <div id="right">
            <div id="welcome" style="overflow-y:scroll;">
                ...
                <table style="width:715px;"><thead><tr><th COLSPAN="4"><h3 style="text-align:left;">Grandes Áreas CNPQ</h3></th>
                         </tr></thead><tbody></tbody></thead>
                </table>
                <div id="welcome" style="height: 200px;overflow-y:scroll;">${grandesAreasTabela}</div> 
                <br><table style="width:715px;"><thead><tr><th COLSPAN="4"><h3 style="text-align:left;">Áreas CNPQ</h3></th>
                         </tr></thead><tbody></tbody></thead>
                </table> 
                <div id="welcome" style="height: 200px;overflow-y:scroll;">${areasTabela}</div>
                <br><table style="width:715px;"><thead><tr><th COLSPAN="4"><h3 style="text-align:left;">Sub-áreas CNPQ</h3></th>
                         </tr></thead><tbody></tbody></thead>
                </table>
                <div id="welcome" style="height: 200px;overflow-y:scroll;">${subAreasTabela}</div>
                <br><table style="width:715px;"><thead><tr><th COLSPAN="4"><h3 style="text-align:left;">Especialidades CNPQ</h3></th>
                         </tr></thead><tbody></tbody></thead>
                </table>
                <div id="welcome" style="height: 200px;overflow-y:scroll;">${especialidadesTabela}</div>
