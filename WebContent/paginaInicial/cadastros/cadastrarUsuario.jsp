    ...
    <div id="content">
        ...
        <div id="right">
            <div id="welcome" style="overflow-y:scroll;">
                    <form method="post" action="/TP01_publicacoesUFSJ/ServletCadastraUsuario">
            
                        <table border="1" width="30%" cellpadding="2">
                            <thead>
                                <tr>
                                    <th colspan="2"><h3>Cadastrar usuário</h3></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width:80%;"><input size="75" type="text" name="cpf" value="" /></td>
                                </tr>
                                <tr>
                                    <td style="width:20%;">Login</td>
                                    <td style="width:80%;"><input size="75" type="text" name="loginCad" value="" /></td>
                                </tr>
                                <tr>
                                    <td style="width:20%;">Senha</td>
                                    <td style="width:80%;"><input size="75" type="text" name="senhaCad" value="" /></td>
                                </tr>
                                <tr>
                                    <td style="width:20%;">Telefone</td>
                                    <td style="width:80%;"><input size="75" type="text" name="telefone" value="" /></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:80%;">
										<select name="tipo" id="tipo">
                                    		...
                                    		<option value="ProReitor">Pró-reitor</option>
                                ...
                                <tr>
                                    ...
                                    <td style="width:80%;">
                                    	<select name="codDepartamento" id="codDepartamento">
                                    		...
                                    		<option value="DEQUI">DEQUI</option>
                                    		<option value="DETEM">DETEM</option>
                                    		<option value="DQBIO">DQBIO</option>
                                ...
                                <tr>
                                    ...
                                    <td style="width:80%;"><input size="75" type="text" name="cep" value="" /></td>
                                </tr>
                                <tr>
                                    <td style="width:20%;">Logradouro</td>
                                    <td style="width:80%;"><input size="75" type="text" name="logradouro" value="" /></td>
                                </tr>
                                <tr>
                                    <td style="width:20%;">Bairro</td>
                                    <td style="width:80%;"><input size="75" type="text" name="bairro" value="" /></td>
                                </tr>
                                <tr>
                                    <td style="width:20%;">Cidade</td>
                                    <td style="width:80%;"><input size="75" type="text" name="cidade" value="" /></td>
                                </tr>
                                <tr>
                                    <td style="width:20%;">Estado</td>
                                    <td style="width:80%;"><input size="75" type="text" name="estado" value="" /></td>
                                </tr>
                                <td><button type="submit" name="Submit" value="Cadastrar usuario">Cadastrar</button></td>  
                                <td><button type="reset">Resetar</button></td>
                            </tbody>
                        </table>
                        <p>${mensagemCadastroUsuario}</p>
                    </form>
                    <br>
                    <br>
