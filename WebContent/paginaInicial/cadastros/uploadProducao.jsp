    ...
    <div id="content">
        ...
        <div id="right">
            <div id="welcome" style="overflow-y:scroll;">
                    ...
                    <form method="post" action="/TP01_publicacoesUFSJ/ServletUploadProducao" id="demoForm" class="demoForm" enctype="multipart/form-data">
            
                        <table border="1" width="30%" cellpadding="2">
                            <thead>
                                <tr>
                                    <th colspan="2"><h3>Upload produção</h3></th>
                                </tr>
                            </thead>
                            <tbody>
			                  <tr>
			                      <td style="width:20%;">Arquivo (pdf)</td>
			                      <td style="width:80%;">
			                      	<input type="file" name="pdf" id="pdf" style="height:100%;"/>
			                      </td>
			                  </tr>
			                  <tr><td><button type="submit" name="Submit" value="Upload publicacao">Upload</button></td>  
                               <td></td></tr> 
			                  </tbody>
			             </table>
			       </form>
